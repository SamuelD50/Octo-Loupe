...
class SportActivityService {
  ...
  Future<void> addSportActivity(String section, String? activityId, String discipline, String information, String titleAddress, String streetAddress, String postalCode, String city, double latitude, double longitude, String day, String startHour, String endHour, String profile, String pricing, List<String> categoriesId, List<String> agesId, List<String> daysId, List<String> schedulesId, List<String> sectorsId) async {
  ...
  Future<List<ActivityModel>> getSportActivities(String section) async {
    try {
  ...
  Future<void> updateSportActivity(String activityId, String newDiscipline,
  ...
  Future<void> deleteSportActivity(String activityId) async {
